struct Story {
    ...
    "Next Lisa tried Hulu, but that was down as well. She checked her gmail but there was a connectivity issue making it to where she could not receive any incoming emails or view her saved emails. ‘What the heck is going on?!’ Lisa yelled.",
    ...
    "Lisa was determined to fix this mess. She needed to finish watching Ozark so she could talk about it with her friends on their next Zoom call.",
    "With the internet barley working Lisa had to do some old school research. She found the phone number and location of the nearest cloud data center. After giving them a call, she found out that the data center was under a phishing attack. ‘How is this possible?’ Lisa asked herself.",
    ...
    "Thankfully Lisa knew how to handle this! She wrote a foolproof malware detection script for her CyberSecurity class last semester. She was certain that if the data center only used her script they could protect themselves from the phishing attacks and get the cloud back up and running.",
